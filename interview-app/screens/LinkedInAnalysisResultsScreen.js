...
export default function LinkedInAnalysisResultsScreen() {
    ...
    return (
      <View style={styles.analysisContainer}>
        <View style={styles.analysisHeader}>
          <Ionicons name="logo-linkedin" size={32} color="#00ff00" />
          <Text style={styles.analysisTitle}>LinkedIn Profile Overview</Text>
        </View>
    ...
    return (
      <View style={styles.qualityContainer}>
        ...
        <View style={styles.scoresSection}>
          ...
          {results.connection_quality_score && (
            <View style={styles.scoreItem}>
              <Text style={styles.scoreLabel}>Connection Quality</Text>
              <Text style={[styles.scoreValue, { color: getScoreColor(results.connection_quality_score) }]}>
                {results.connection_quality_score}/100
              </Text>
            </View>
          )}
          ...
          {error ? (
            ...
            <>
              ...
              <View style={styles.tabContainer}>
                {renderTabButton('overview', 'Overview', 'logo-linkedin')}
            ...
            <View style={styles.errorContainer}>
              <Ionicons name="logo-linkedin" size={48} color="#ff4444" />
