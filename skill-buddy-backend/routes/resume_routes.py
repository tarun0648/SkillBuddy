...
@resume_bp.route('/improvements/<resume_id>', methods=['GET'])
@auth_required
def get_resume_improvements(resume_id):
    """Alias for get_resume_improvement_suggestions - frontend compatibility"""
    return get_resume_improvement_suggestions(resume_id)