...
@profile_analysis_bp.route('/user', methods=['GET'])
@auth_required
def get_user_analysis_statistics():
    ...
    try:
        ...
        statistics = profile_analysis_model.get_user_analysis_statistics(user_id)
        
        # Get user analyses for additional context
        analyses = profile_analysis_model.get_user_analyses(user_id)
        ...
        return jsonify({'error': 'Failed to get analysis statistics', 'details': str(e)}), 500
